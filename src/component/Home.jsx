...
function Home() {
  ...
  <div class="relative z-10 flex flex-col justify-center items-center h-full text-center">
    ...
    <a href="/Loginpage" class="bg-yellow-400 text-gray-900 hover:bg-yellow-300 py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Sign in</a>
  </div>
</div>
